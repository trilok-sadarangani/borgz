...
describe('game socket integration', () => {
    ...
    test('leave-game then rejoin-game works (game stays until host ends)', async () => {
        ...
        const rejoinStateP = (0, socketTestHarness_1.waitForEvent)(p1, 'game-state', 1500);
        p1.emit('join-game', { gameCode: code, playerId: 'p1' });
    ...
    test('happyPath_twoPlayers_stateBroadcasts', async () => {
        ...
        const p1JoinStateP = (0, socketTestHarness_1.waitForEvent)(p1, 'game-state', 1500);
        p1.emit('join-game', { gameCode: code, playerId: 'p1' });
        const p1JoinState = await p1JoinStateP;
        const p2JoinStateP = (0, socketTestHarness_1.waitForEvent)(p2, 'game-state', 1500);
        ...
        const p2StartStateP = (0, socketTestHarness_1.waitForEvent)(p2, 'game-state', 1500);
        p1.emit('start-game');
    ...
    test('rejectNotYourTurn_emitsError_andStateUnchanged', async () => {
        ...
        const errP = (0, socketTestHarness_1.waitForEvent)(nonActiveSocket, 'error', 1500);
        nonActiveSocket.emit('player-action', { action: 'call' });
        const err = await errP;
        expect(err.message).toBe('Not your turn');
        // Request state after the rejected action and confirm history didn't change.
        const p1AfterP = (0, socketTestHarness_1.waitForEvent)(p1, 'game-state', 1500);
    ...
    test('race_doubleAction_onlyOneApplied', async () => {
        ...
        const s1 = (0, socketTestHarness_1.waitForEvent)(p1, 'game-state', 1500);
        const s2 = (0, socketTestHarness_1.waitForEvent)(p2, 'game-state', 1500);
        const errP = (0, socketTestHarness_1.waitForEvent)(activeSocket, 'error', 500).catch(() => null);
...
describe('game chat socket integration', () => {
    ...
    test('send-chat broadcasts message to all players in game', async () => {
        ...
        const p1ChatP = (0, socketTestHarness_1.waitForEvent)(p1, 'chat-message', 1500);
        const p2ChatP = (0, socketTestHarness_1.waitForEvent)(p2, 'chat-message', 1500);
    ...
    test('send-chat rejects empty message', async () => {
        ...
        const errP = (0, socketTestHarness_1.waitForEvent)(p1, 'error', 1500);
    ...
    test('send-chat truncates long messages to 500 chars', async () => {
        ...
        const chatP = (0, socketTestHarness_1.waitForEvent)(p1, 'chat-message', 1500);
    ...
    test('chat messages have unique IDs', async () => {
        ...
        const chat1P = (0, socketTestHarness_1.waitForEvent)(p1, 'chat-message', 1500);
        p1.emit('send-chat', { message: 'First message' });
        const chat1 = await chat1P;
        const chat2P = (0, socketTestHarness_1.waitForEvent)(p1, 'chat-message', 1500);
    ...
    test('multiple players can send and receive chat messages', async () => {
        ...
        // p1 sends message
        const chat1P1 = (0, socketTestHarness_1.waitForEvent)(p1, 'chat-message', 1500);
        const chat1P2 = (0, socketTestHarness_1.waitForEvent)(p2, 'chat-message', 1500);
        ...
        // p2 sends message
        const chat2P1 = (0, socketTestHarness_1.waitForEvent)(p1, 'chat-message', 1500);
        const chat2P2 = (0, socketTestHarness_1.waitForEvent)(p2, 'chat-message', 1500);
