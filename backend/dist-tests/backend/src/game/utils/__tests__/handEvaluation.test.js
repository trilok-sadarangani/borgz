...
const handEvaluation_1 = require("../handEvaluation");
describe('Hand Evaluation', () => {
    describe('Royal Flush', () => {
        it('should identify a royal flush', () => {
            ...
            const result = (0, handEvaluation_1.evaluateHand)(holeCards, communityCards);
    ...
    describe('Edge Cases and Best 5-Card Selection', () => {
        ...
        it('should throw error when less than 5 cards available', () => {
            ...
            expect(() => (0, handEvaluation_1.evaluateHand)(holeCards, communityCards)).toThrow('Need at least 5 cards');
        });
        it('should recognize when the board plays (no improvement from hole cards)', () => {
            ...
            const p1 = (0, handEvaluation_1.evaluateHand)([
                { suit: 'clubs', rank: '2' },
                { suit: 'diamonds', rank: '3' },
            ], board);
            const p2 = (0, handEvaluation_1.evaluateHand)([
                { suit: 'clubs', rank: '4' },
                { suit: 'diamonds', rank: '5' },
            ], board);
            expect(p1.rank).toBe('straight');
            expect(p2.rank).toBe('straight');
            expect((0, handEvaluation_1.compareHands)(p1, p2)).toBe(0);
        });
    ...
    describe('compareHands', () => {
        it('should correctly compare hand ranks', () => {
            ...
            expect((0, handEvaluation_1.compareHands)(royalFlush, pair)).toBeGreaterThan(0);
            expect((0, handEvaluation_1.compareHands)(pair, royalFlush)).toBeLessThan(0);
        });
        it('should compare kickers when ranks are equal', () => {
            ...
            expect((0, handEvaluation_1.compareHands)(pairAces, pairKings)).toBeGreaterThan(0);
        });
        it('should return 0 for identical hands', () => {
            ...
            expect((0, handEvaluation_1.compareHands)(hand1, hand2)).toBe(0);
        });
        it('should compare full houses correctly', () => {
            const fullHouseKingsOverQueens = {
                rank: 'full-house',
                value: 7,
                cards: [],
                kickers: [13, 12], // Kings over Queens
            };
            const fullHouseQueensOverKings = {
                rank: 'full-house',
                value: 7,
                cards: [],
            ...
            expect((0, handEvaluation_1.compareHands)(fullHouseKingsOverQueens, fullHouseQueensOverKings)).toBeGreaterThan(0);
        });
        it('should compare two pairs correctly', () => {
            const twoPairAcesAndKings = {
                rank: 'two-pair',
                value: 3,
                cards: [],
                kickers: [14, 13, 12], // Aces, Kings, Queen kicker
            };
            const twoPairAcesAndQueens = {
                rank: 'two-pair',
                value: 3,
                cards: [],
            ...
            expect((0, handEvaluation_1.compareHands)(twoPairAcesAndKings, twoPairAcesAndQueens)).toBeGreaterThan(0);
        });
        it('should compare three of a kind with different kickers', () => {
            const tripsAcesWithKing = {
                rank: 'three-of-a-kind',
                value: 4,
                cards: [],
                kickers: [14, 13, 12], // Aces, King, Queen
            };
            const tripsAcesWithQueen = {
                rank: 'three-of-a-kind',
                value: 4,
                cards: [],
                kickers: [14, 12, 11], // Aces, Queen, Jack
            };
            expect((0, handEvaluation_1.compareHands)(tripsAcesWithKing, tripsAcesWithQueen)).toBeGreaterThan(0);
        });
        it('should compare straights correctly', () => {
            const straightKingHigh = {
                rank: 'straight',
                value: 5,
                cards: [],
                kickers: [13], // King-high straight
            };
            const straightQueenHigh = {
                rank: 'straight',
                value: 5,
                cards: [],
                kickers: [12], // Queen-high straight
            };
            expect((0, handEvaluation_1.compareHands)(straightKingHigh, straightQueenHigh)).toBeGreaterThan(0);
        });
        it('should compare flushes correctly by high card', () => {
            ...
            expect((0, handEvaluation_1.compareHands)(flushAceHigh, flushKingHigh)).toBeGreaterThan(0);
        });
        it('should compare high cards correctly', () => {
            ...
            expect((0, handEvaluation_1.compareHands)(aceHigh, kingHigh)).toBeGreaterThan(0);
        });
        it('should handle different length kickers', () => {
            ...
            expect((0, handEvaluation_1.compareHands)(hand1, hand2)).toBeLessThan(0);
        });
    });
});
